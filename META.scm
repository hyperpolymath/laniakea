...
(define architecture-decisions
  '((adr-001
     ...
     (status . "accepted")
     (date . "2025-12-15")
     (context . "*The browser isn't a client — it's a peer node in a distributed system where state flows and converges.*")
...
(define development-practices
  '((code-style
     (languages . ("Elixir" "JavaScript" "Just" "Nickel" "Nix" "ReScript" "Scheme" "Shell" "TypeScript"))
