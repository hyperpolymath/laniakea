...
First off, thank you for considering contributing to Laniakea! It’s
people like you that make Laniakea such a great tool for building
distributed web applications.

=== Table of Contents

* link:#code-of-conduct[Code of Conduct]
* link:#tpcf-perimeter-model[TPCF Perimeter Model]
...
* link:#style-guides[Style Guides]
...
link:CODE_OF_CONDUCT.md[Laniakea Code of Conduct]. By participating, you
are expected to uphold this code.

=== TPCF Perimeter Model

Laniakea uses the *Tri-Perimeter Contribution Framework (TPCF)* for
graduated access:
...
|*P2: Trusted* |Review + merge for specific areas |Multiple accepted
PRs, domain expertise

|*P3: Community* |PR submission, issue creation |Signed CLA, follows
code of conduct
|===

New contributors start at P3. Advancement is based on: - Quality and
quantity of contributions - Responsiveness to feedback - Community
engagement - Domain expertise

See MAINTAINERS.md for current perimeter assignments.
...
* Use Markdown (`+.md+`) for GitHub-specific files (README,
CONTRIBUTING, etc.)
...
* *Discord*: https://discord.gg/laniakea[Join our server]
* *Discussions*: https://github.com/laniakea/laniakea/discussions[GitHub
Discussions]
* *Issues*: https://github.com/laniakea/laniakea/issues[GitHub Issues]

'''''

Thank you for contributing to Laniakea! Together, we’re building the
future of distributed web applications.
