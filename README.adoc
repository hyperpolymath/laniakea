...
:experimental:
:url-github: https://github.com/hyperpolymath/laniakea
:url-gitlab: https://gitlab.com/hyperpolymath/laniakea
:url-bitbucket: https://bitbucket.org/hyperpolymath/laniakea
:url-codeberg: https://codeberg.org/hyperpolymath/laniakea

Galactic-scale distributed systems toolkit
...
laniakea is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
