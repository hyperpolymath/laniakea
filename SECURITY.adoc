...
[arabic]
. *Email*: security@laniakea.dev
. *Security Advisory*:
https://github.com/laniakea/laniakea/security/advisories/new[Create a
...
destruction, or service interruption
* Only interact with accounts you own or with explicit permission
* Do not exploit vulnerabilities beyond what is necessary to demonstrate
the issue
* Report vulnerabilities promptly and provide reasonable time for
remediation
...
See `+.well-known/security.txt+` for machine-readable security
information.
...
_This security policy follows the
https://github.com/rhodium-standard[Rhodium Standard Repository]
guidelines._
