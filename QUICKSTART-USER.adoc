...
// Replace laniakea, Laniakea — See README.adoc for details., just run, Laniakea started successfully. with actuals
= laniakea — Quick Start for Users
:toc:
:toclevels: 2

== What is laniakea?

Laniakea — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./laniakea-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/laniakea/wiki
